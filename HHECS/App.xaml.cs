...
namespace HHECS
{
    ...
    public partial class App : Application
    {
        ...
        {
            bool ret;
            var mutex = new System.Threading.Mutex(true, "ECS", out ret);
            ...
            System.Diagnostics.Process[] myProcesses = System.Diagnostics.Process.GetProcessesByName("HHECS");//获取指定的进程名  
        ...
        {
            bool createNew;
            Mutex mutex = new Mutex(true, "HHECS", out createNew);
            if (createNew)
                base.OnStartup(e);
            else
            {
